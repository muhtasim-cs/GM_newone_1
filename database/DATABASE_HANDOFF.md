...
### Method A: Using Prisma ORM (Node.js / TypeScript)
...
### Method B: Standalone PostgreSQL Deployment (`psql`)

To deploy directly to any local or cloud PostgreSQL instance without Node.js:
...
psql -U postgres -d grambandhan -f database/grambandhan_unified_schema.sql
```
